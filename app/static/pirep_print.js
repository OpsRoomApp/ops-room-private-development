(()=>{
  ...
  function footer(page,total){const d=document.createElement('div');d.className='pdf-page-foot';d.innerHTML=`<span>OPS ROOM 0.25.60</span><span>PAGE ${page} / ${total}</span><span>OPS ROOM</span>`;return d}
