"""Regression tests for Real World Search pipeline – v0.25.60.

Covers all v0.25.46 root-cause fixes and v0.25.60 hardening features.
...
# ── Test K: ADSBDB enrichment (v0.25.60) ─────────────────────────────────────
...
# ── Test L: FR24 list→dict conversion (v0.25.60) ────────────────────────────
...
# ── Test M: Multi-term search (v0.25.60) ────────────────────────────────────
...
# ── Test N: Performance / non-blocking cache (v0.25.60) ─────────────────────
