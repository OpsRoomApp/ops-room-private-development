# OPS ROOM v0.25.59 — Complete API & WebSocket Specification
...
```json
{
  ...
  "current_version": "0.25.59",
  "latest_version": "0.25.59",
  "channel": "stable"
}
```
...
```json
{
  ...
  "latest_version": "0.25.59",
  "manifest": { "version": "0.25.59", "download_url": "...", "sha256": "..." }
}
```
...
**Response (200):**
```json
{ "ok": true, "staged_version": "0.25.59", "staged_path": "..." }
```
