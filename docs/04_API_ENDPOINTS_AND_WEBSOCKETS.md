# OPS ROOM v0.25.53 — Complete API & WebSocket Specification
...
```json
{
  ...
  "current_version": "0.25.53",
  "latest_version": "0.25.53",
  "channel": "stable"
}
```
...
```json
{
  ...
  "latest_version": "0.25.53",
  "manifest": { "version": "0.25.53", "download_url": "...", "sha256": "..." }
}
```
...
**Response (200):**
```json
{ "ok": true, "staged_version": "0.25.53", "staged_path": "..." }
```
