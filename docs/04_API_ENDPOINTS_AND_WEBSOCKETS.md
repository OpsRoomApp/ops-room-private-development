# OPS ROOM v0.25.52 — Complete API & WebSocket Specification
...
```json
{
  ...
  "current_version": "0.25.52",
  "latest_version": "0.25.52",
  "channel": "stable"
}
```
...
```json
{
  ...
  "latest_version": "0.25.52",
  "manifest": { "version": "0.25.52", "download_url": "...", "sha256": "..." }
}
```
...
**Response (200):**
```json
{ "ok": true, "staged_version": "0.25.52", "staged_path": "..." }
```
