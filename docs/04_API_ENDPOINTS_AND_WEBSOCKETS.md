# OPS ROOM v0.25.49 — Complete API & WebSocket Specification
...
```json
{
  ...
  "current_version": "0.25.49",
  "latest_version": "0.25.49",
  "channel": "stable"
}
```
...
```json
{
  ...
  "latest_version": "0.25.49",
  "manifest": { "version": "0.25.49", "download_url": "...", "sha256": "..." }
}
```
...
**Response (200):**
```json
{ "ok": true, "staged_version": "0.25.49", "staged_path": "..." }
```
