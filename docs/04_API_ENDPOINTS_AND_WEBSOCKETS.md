# OPS ROOM v0.25.51 — Complete API & WebSocket Specification
...
```json
{
  ...
  "current_version": "0.25.51",
  "latest_version": "0.25.51",
  "channel": "stable"
}
```
...
```json
{
  ...
  "latest_version": "0.25.51",
  "manifest": { "version": "0.25.51", "download_url": "...", "sha256": "..." }
}
```
...
**Response (200):**
```json
{ "ok": true, "staged_version": "0.25.51", "staged_path": "..." }
```
