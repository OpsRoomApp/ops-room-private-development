# OPS ROOM v0.25.50 — Complete API & WebSocket Specification
...
```json
{
  ...
  "current_version": "0.25.50",
  "latest_version": "0.25.50",
  "channel": "stable"
}
```
...
```json
{
  ...
  "latest_version": "0.25.50",
  "manifest": { "version": "0.25.50", "download_url": "...", "sha256": "..." }
}
```
...
**Response (200):**
```json
{ "ok": true, "staged_version": "0.25.50", "staged_path": "..." }
```
