# OPS ROOM v0.25.61 — Complete API & WebSocket Specification
...
```json
{
  ...
  "current_version": "0.25.61",
  "latest_version": "0.25.61",
  "channel": "stable"
}
```
...
```json
{
  ...
  "latest_version": "0.25.61",
  "manifest": { "version": "0.25.61", "download_url": "...", "sha256": "..." }
}
```
...
**Response (200):**
```json
{ "ok": true, "staged_version": "0.25.61", "staged_path": "..." }
```
