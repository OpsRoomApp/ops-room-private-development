# OPS ROOM v0.25.54 — Complete API & WebSocket Specification
...
```json
{
  ...
  "current_version": "0.25.54",
  "latest_version": "0.25.54",
  "channel": "stable"
}
```
...
```json
{
  ...
  "latest_version": "0.25.54",
  "manifest": { "version": "0.25.54", "download_url": "...", "sha256": "..." }
}
```
...
**Response (200):**
```json
{ "ok": true, "staged_version": "0.25.54", "staged_path": "..." }
```
