# OPS ROOM v0.25.47 — Complete API & WebSocket Specification
...
```json
{
  ...
  "current_version": "0.25.47",
  "latest_version": "0.25.47",
  "channel": "stable"
}
```
...
```json
{
  ...
  "latest_version": "0.25.47",
  "manifest": { "version": "0.25.47", "download_url": "...", "sha256": "..." }
}
```
...
**Response (200):**
```json
{ "ok": true, "staged_version": "0.25.47", "staged_path": "..." }
```
