...
cd /d "%~dp0"
title Build OPS ROOM 0.25.0 Public Release Complete Package

echo ================================================================
echo OPS ROOM 0.25.0 Public Release build
...
if exist "%DIST_DIR%\OPS_ROOM_v0_25_0_Public_Windows_x64.zip" del "%DIST_DIR%\OPS_ROOM_v0_25_0_Public_Windows_x64.zip"
...
"%VENV_PY%" tools\write_update_manifest.py --version 0.25.0 --channel stable --site https://opsroom.live --zip "%DIST_DIR%\OPS_ROOM_v0_25_0_Public_Windows_x64.zip" --out "%DIST_DIR%\update.json" || goto :fail
...
"%VENV_PY%" tools\write_update_manifest.py --version %OPSROOM_VERSION% --channel stable --site https://opsroom.live --zip "%DIST_DIR%\OPS_ROOM_v0_25_0_Public_Windows_x64.zip" --installer "dist_installer\OPS_ROOM_Setup_%OPSROOM_VERSION%.exe" --out "%DIST_DIR%\update.json" || goto :fail
"%VENV_PY%" tools\validate_v0256_public_release.py --dist "%DIST_DIR%" || goto :fail
...
:fail
echo.
echo OPS ROOM 0.25.0 Public Release complete build failed. Review the first ERROR above.
pause
exit /b 1
